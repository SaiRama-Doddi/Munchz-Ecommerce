  ...
  const steps = [
    {
      ...
      desc: "Finest Foxnuts (Makhana) and premium dry fruits sourced from sustainable farms.",
      badge: "100% Natural",
    ...
    },
    {
      ...
      desc: "Slow-roasted to crunchy perfection, preserving all natural nutrients and taste.",
    ...
    },
    {
      ...
      desc: "Tossed in small batches with our secret blend of natural spices for a burst of unreal flavor.",
      badge: "Real Spices",
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-5">
            <div className="space-y-2.5">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-base font-bold tracking-wider text-green-700 bg-green-50 border border-green-200/50 uppercase">
