...
{ to: "/productpage", label: "Shop", icon: <Grid2x2 size={18}/> },
{ to: "/Aboutmain", label: "About", icon: <Info size={18}/> },
{ to: "/track", label: "Track", icon: <MapPin size={18}/> },
...
to={item.to}
className={({isActive}) =>
`flex items-center gap-2 relative pb-1 transition ${
isActive
