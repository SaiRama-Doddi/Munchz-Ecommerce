  ...
  return (
    <div className="h-[calc(100vh-120px)] md:h-[calc(100vh-112px)] bg-[#f9fdf7] flex items-center justify-center px-4 overflow-hidden">
      <div className="max-w-4xl w-full h-auto max-h-[85vh] bg-[#ecfdf5] rounded-[2rem] shadow-2xl overflow-hidden grid md:grid-cols-2 border border-green-100/50">
        ...
        {/* RIGHT FORM SECTION */}
        <div className="p-5 md:p-6 bg-[#ecfdf5] flex flex-col justify-center">
          ...
          {/* ORDER TYPE SELECTOR */}
          <div className="flex bg-white/50 p-1 rounded-2xl gap-2 mb-3 w-fit border border-white">
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-2.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-2.5 rounded-2xl border-2 border-white bg-white/80 focus:bg-white outline-none focus:border-green-400 focus:ring-4 focus:ring-green-100 transition-all font-semibold text-black placeholder:text-gray-500 text-xs"
                  required
                />
              </div>
              <div className="relative">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={2}
                className="w-full pl-12 pr-4 py-2.5 rounded-2xl border-2 border-white bg-white/80 focus:bg-white outline-none focus:border-green-400 focus:ring-4 focus:ring-green-100 transition-all font-semibold text-black placeholder:text-gray-500 resize-none text-xs"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-green-600 hover:bg-green-700 text-white font-bold px-10 py-3 rounded-2xl shadow-lg shadow-green-200 transition-all hover:-translate-y-0.5 active:scale-95 flex items-center justify-center gap-3 decoration-0 text-xs"
            >
              <FaWhatsapp size={20} />
